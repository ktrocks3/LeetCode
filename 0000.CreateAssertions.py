...
Output: [3,2,1]""", 'wonderfulSubstrings')
formatLC("""Input: n = 4, queries = [[0,3],[0,2]]
Output: [1,1]""", 'wonderfulSubstrings')
testcases("""15
[[10,12],[6,12]]
14
[[0,6],[4,12]]
